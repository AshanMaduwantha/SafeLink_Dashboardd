        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="aspect-video bg-gray-900 rounded-lg">
              <LiveStreamViewer channelName={channelName} onLeave={stopViewing} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="border border-gray-200 rounded-lg p-6 hover:border-blue-500 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Channel: {DEFAULT_CHANNEL}</p>
                <div className="mt-2">
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
            <h4 className="font-semibold text-blue-900 m mb-2">📱 Broadcasting from Mobile</h4>
            <p className="text-sm text-blue-700">
              Start a live stream from the mobile app to see it here. The stream will appear
              automatically when a broadcaster joins the channel.
            </p>
          </div>
        </div>
      </div>
